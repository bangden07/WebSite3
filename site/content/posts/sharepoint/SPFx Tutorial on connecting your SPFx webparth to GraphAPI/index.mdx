---
title: SPFx Tutorial on connecting your SPFx webpart to GraphAPI
category: ReactJS
author: Billy Peralta
tags: ['Graph', 'SPFx', 'ReactJS', 'ReactJS']
keywords: ['Graph', 'SPFx', 'ReactJS', 'ReactJS']
date: 2020-11-08
thumbnail: image.jpg
---
...
![yo @microsoft/sharepoint](/PostImages/yo.JPG)
...
const AccessGraphApi = async (graphContext: WebPartContext): Promise<any> => {
  graphContext.msGraphClientFactory
    .getClient()
...
![Uploading our spkg file to the app catalog](/PostImages/AppUpload.JPG)
...
![Approve the permission request requested by the webpart](/PostImages/PermissionRequest.JPG)

14. To test try going to any site collection, install the webpart and use the webpart to any page of the site collectionn

![Approve the permission request requested by the webpart](/PostImages/usingWebpart.JPG)

15. Open up your developer toolbar then console and then try press the button.

![Approve the permission request requested by the webpart](/PostImages/ButtonPress.JPG)
